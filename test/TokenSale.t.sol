    ...
    contract TokenSaleTest is Test {
        ...
        function setUp() public {
            ...
            address proxyAddress = Upgrades.deployTransparentProxy(
                ...
                admin,
                abi.encodeCall(TokenSale.initialize, (address(baseToken), paymentRecipient, admin))
            );
        ...
        function test_NonAdminCannotConfigureSale() public {
            vm.prank(user1);
            vm.expectRevert();
            tokenSale.configureSale(
                10000 * 10 ** 18, 100 * 10 ** 18, 5000 * 10 ** 18, block.timestamp + 1 days, block.timestamp + 7 days
            );
        }
        ...
        function test_GetUserPurchasesByToken() public {
            ...
            assertEq(
                tokenSale.getUserPurchasesByToken(user1, address(usdc)),
                tokenSale.purchasedByToken(user1, address(usdc))
            );
        }
        ...
        function test_SlippageProtectionMinTokensOut() public {
            ...
            uint256 tokensReceived =
                tokenSale.purchaseWithToken(address(usdc), paymentAmount, expectedTokens / 2, bytes32(0));
            vm.stopPrank();
